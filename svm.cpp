...
public:
    ...
    virtual void Solve(int l, const QMatrix &Q, const double *p_, const schar *y_,
...
public:
    ...
    void Solve(int l, const QMatrix &Q, const double *p, const schar *y,
               ...
               SolutionInfo *si, int shrinking) override {
        this->si = si;
...
svm_model *svm_train(const svm_problem *prob, const svm_parameter *param) {
    ...
    if (param->svm_type == ONE_CLASS ||
        ...
        if (nr_class == 1)
            info("WARNING: training data in only one class. See README.md for details.\n");
